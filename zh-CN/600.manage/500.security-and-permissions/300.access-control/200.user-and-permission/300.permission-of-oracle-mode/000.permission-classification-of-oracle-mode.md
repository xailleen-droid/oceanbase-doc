...
| 对象权限 | READ                        | 读权限。              |
| 对象权限 | WRITE                       | 写权限。              |
| 对象权限 | USE CATALOG                 | 执行 `SET CATALOG`、`SHOW CATALOGS`、`SHOW CREATE CATALOG`、`SELECT FROM CATALOG` 语句的权限。|
...
| 系统权限 | USE ANY CATALOG             | 执行 `SET CATALOG`、`SHOW CATALOGS`、`SHOW CREATE CATALOG`、`SELECT FROM CATALOG` 语句的权限。|
| 系统权限 | CREATE CATALOG              | 执行 `CREATE EXTERNAL CATALOG`、`DROP CATALOG` 语句的权限。|
