...
3. 执行成功后，可以通过查询 `DBA_OB_RSRC_DIRECTIVES` 视图进行确认。
   ...
   有关 `DBA_OB_RSRC_DIRECTIVES` 视图的详细介绍，参见 [DBA_OB_RSRC_DIRECTIVES](../../../../../700.reference/700.system-views/500.system-view-of-oracle-mode/200.dictionary-view-of-oracle-mode/15020.dba_ob_rsrc_directives-of-oracle-mode.md)。
