...
> 说明
  本文以 ob-operator V2.3.1 为例介绍操作步骤，其他版本可能略有不同。不同版本的操作步骤可参见 ob-operator 手册 中对应版本内容。
...
> **说明**
>
> 除了针对集群和租户的性能指标监控功能外，OceanBase Dashboard 还提供了集群管理、租户管理、备份管理、 OBProxy 管理和终端连接等功能。
