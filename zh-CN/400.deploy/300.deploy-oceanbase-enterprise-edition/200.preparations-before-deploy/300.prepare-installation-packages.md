...
> 说明
  请在 OceanBase 软件下载中心 下载 OceanBase 数据库以及配套工具、驱动和中间件的安装包。如果未找到对应版本的安装包，请联系技术支持获取。

**部署 OceanBase 集群使用的镜像和安装包如下表所示：**

> **说明**
>
> 使用命令行部署 OceanBase 集群无需准备部署 OceanBase 云平台相关的镜像/安装包。
...
<table>
   ...
   <tr>
       ...
       <td>OAT docker image </br>或者</br>oat-all-in-one 安装包 > 说明新环境推荐您使用 oat-all-in-one 安装包安装 OAT。oat-all-in-one 安装包提供了 Docker，OAT，MetaDB、NLB 镜像及常用工具软件包。</td>
       <td>用于安装 OAT。</td>
   ...
   <tr>
       <td>MetaDB docker image > **注意**
>
> 如果使用的 OAT docker image 安装 OAT，安装 OCP 时还需要提供 MetaDB docker image。</td>
   ...
   <tr>
       ...
       <td><ul><li>X86_64 平台：
            ...
            > **说明**
>
> 操作系统 Rocky Linux 9 和 Alibaba Cloud Linux 3 推荐使用 OceanBase 数据库 al8 安装包。
        </td>
   </tr>
   <tr>
