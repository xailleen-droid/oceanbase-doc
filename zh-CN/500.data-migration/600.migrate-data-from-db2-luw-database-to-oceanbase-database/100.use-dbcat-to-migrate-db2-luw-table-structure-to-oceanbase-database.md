...
此处以导出 DB2 LUW V11.5.x 下 database 为 test 的所有对象的结构，并将其迁移到 OceanBase 数据库 MySQL 兼容模式租户 V4.0.0 为例。
...
* 下表为您介绍目前支持的源端和目标端数据库的详细版本。
  ...
  | POLARDB-ORACLE > **注意**
>
> 运行 dbcat 时，POLARDB-ORACLE 除数据库版本号之外，其他所需参数配置与 pgsql 一致。 | polardb_o8 <br> polardb_o82 <br> polardb_o9 <br> polardb_o91 <br> polardb_o10 <br> polardb_o11 <br> polardb_o12 <br> polardb_o13 <br> polardb_o14 <br> polardb_o15 |
