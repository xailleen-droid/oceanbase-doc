...
本教程结合通义千问 API 演示如何将 OceanBase 数据库中的 [向量检索功能](../../640.ob-vector-search/100.ob-vector-search-overview/100.ob-vector-search-intro.md)、[通义千问](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000001579715) 与 [LangChain](https://python.langchain.com/) 集成实现文档问答。
...
* `$database_name`：需要访问的数据库名称。
    ...
    > 注意
        连接租户的用户需要拥有该数据库的 CREATE、INSERT、DROP 和 SELECT 权限。更多有关用户权限的信息，请参见 MySQL 模式下的权限分类。
