...
> 说明
  该错误码从 V4.3.0 版本开始报错信息由 the format file does not exist under the destination 调整为 format file does not exist%s。
...
> 说明
  该错误码从 V4.3.0 版本开始报错信息由 the content of the format file at the destination does not match 调整为 format file does not match%s。
