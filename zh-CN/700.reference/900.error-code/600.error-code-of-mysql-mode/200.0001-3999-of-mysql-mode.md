...
> 说明
  在 V4.3.x 版本中，该错误码从 V4.3.2 版本开始引入。在 V4.2.x 版本中，该错误码从 V4.2.4 版本开始引入。
...
> 说明
  对于 V4.3.x 版本，该错误码从 V4.3.5 版本开始错误信息由 Event execution time is in the past and ON COMPLETION NOT PRESERVE is set. The event was not changed. Specify a time in the future. 调整为 Event execution time is in the past. The event was not changed. Specify a time in the future.。
