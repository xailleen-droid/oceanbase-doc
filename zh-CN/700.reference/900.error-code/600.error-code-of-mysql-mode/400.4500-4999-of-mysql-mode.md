...
> 说明
  该错误码在 V4.0.0 版本开始进行了修改，错误信息由 ERROR 4719 (HY000) : partition has been dropped   调整为 ERROR 4719 (HY000) : log stream does not exist 。
...
> **说明**
>
> 对于 V4.2.x 版本，该错误码从 V4.2.3 版本开始引入；对于 V4.3.x 版本，该错误码从 V4.3.0 版本开始引入。
