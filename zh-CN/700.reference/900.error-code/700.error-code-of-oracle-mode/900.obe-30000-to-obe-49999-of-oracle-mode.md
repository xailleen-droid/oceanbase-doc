...
> 说明
  该错误码在 V4.1.0 版本开始进行了修改，错误信息由 OBE-00600：Invalid JSON text 调整为 OBE-40441：JSON syntax error。
...
> 说明
  该错误码在 V4.1.0 版本开始进行了修改，错误信息由 OBE-00600：Invalid JSON text in argument 调整为 OBE-40441：JSON syntax error。
...
> 说明
  该错误码在 V4.1.0 版本开始进行了修改，错误信息由 OBE-00600：Invalid JSON path expression  调整为 OBE-40442：JSON path expression syntax error ('INT') 。
...
> 说明
  该错误码在 V4.1.0 版本开始进行了修改，错误信息由  OBE-00600：No value was found by '%.192s' on the specified path 调整为 OBE-40462：No value was found by '%.192s' on the specified path 。
...
> 说明
  该错误码在 V4.1.0 版本开始进行了修改，错误信息由  OBE-00600：More than one value was found by '%.192s' on the specified path 调整为  OBE-40470：More than one value was found by '%.192s' on the specified path。
...
> 说明
  该错误码在 V4.1.0 版本开始进行了修改，错误信息由  OBE-00600：The JSON object contains a key name that is too long 调整为  OBE-40476：JSON key too long。
...
> 说明
  该错误码在 V4.1.0 版本开始进行了修改，错误信息由  OBE-00600：The JSON binary value contains invalid data 调整为  OBE-40783：invalid binary JSON data\nstring。
