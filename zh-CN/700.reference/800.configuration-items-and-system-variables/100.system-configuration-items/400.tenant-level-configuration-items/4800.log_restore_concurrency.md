...
| --- | --- |
| 参数类型 | INT |
| 默认值 | 0，表示使用 OceanBase 数据库自适应的日志恢复并行度。> **说明**
>
> 该配置项从 V4.2.0 版本开始默认值从 1 调整为 0。 |
| 取值范围 | [0，100]> **说明**
>
> 该配置项从 V4.2.0 版本开始取值范围由 [1,100] 调整为 [0,100]。 |
