...
* `cpu_quota_concurrency` 表示租户在每个 CPU 上活跃的工作线程数，也即并发数。`cpu_quota_concurrency` 配置项的详细信息，参见 [cpu_quota_concurrency](../400.tenant-level-configuration-items/1800.cpu_quota_concurrency.md)。
