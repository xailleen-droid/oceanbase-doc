...
|------------------|-----------|
| 参数类型             | Double    |
| 默认值               | 0，表示自适应调整> 说明该配置项从 V4.0.0 版本开始，默认值由 2.5 调整为 1。  该配置项从 V4.2.1 版本开始，默认值由 1 调整为 0。  |
| 取值范围             | [0, 16]> 说明该配置项从 V4.0.0 版本开始取值范围由 [0，16] 调整为 [1，16]。该配置项从 V4.2.1 版本开始取值范围由 [1，16] 调整为 [0，16]。       |
| 是否可修改           | 是，支持通过 `ALTER SYSTEM SET` 语句修改。|
| 是否重启 OBServer 节点生效 | 否> **说明**
>
> 该配置项从 V4.1.0 版本开始生效模式由重启生效调整为立即生效。             |
