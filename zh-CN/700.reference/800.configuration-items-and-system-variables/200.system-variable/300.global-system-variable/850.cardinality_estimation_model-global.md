...
> 说明
  在 V4.3.x 版本中，该视图从 V4.3.3 版本开始引入。在 V4.2.x 版本中，该视图从 V4.2.4 版本开始引入。
...
| 参数类型    |   Enum              |
| 默认值      |  PARTIAL   |
| 取值范围    |  <ul><li>INDEPENDENT：假设谓词间是完全独立的。</li><li>PARTIAL: 假设谓词间有一定程度的相关性。</li><li>FULL：假设谓词间是完全相关的。</li></ul>> 说明在大多数场景下，三种相关性的估行结果会依次变大：INDEPENDENT              |
