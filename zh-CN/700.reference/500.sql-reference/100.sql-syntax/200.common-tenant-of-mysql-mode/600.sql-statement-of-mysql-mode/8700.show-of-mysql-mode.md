...
| RECYCLEBIN                                                                      | 查看回收站。     |
| SEQUENCE | 查看所创建的序列。|
| PROCEDURE CODE proc_name | 查看存储过程 <code>proc_name</code> 的内部实现。> **注意**
>
> 当前版本仅支持该关键字语法，功能不生效。|
| FUNCTION CODE func_name | 查看存储函数 <code>func_name</code> 的内部实现。> **注意**
>
> 当前版本仅支持该关键字语法，功能不生效。|
| ENGIN engine_name | 查看有关存储引擎的操作信息。> **注意**
>
> 当前版本仅支持该关键字语法，功能不生效。|
| OPEN TABLES |用于查看服务器当前已经打开的表及其状态信息。> **注意**
>
> 当前版本仅支持该关键字语法，功能不生效。 |
| CREATE CATALOG external_catalog_name | 用于查看创建 Catalog 的语句。> **说明**
>
> 对于 OceanBase 数据库 V4.3.5 版本，该语句从 V4.3.5 BP2 版本开始支持。|
| CATALOGS | 用于查看当前租户的 Catalog。> **说明**
>
> 对于 OceanBase 数据库 V4.3.5 版本，该语句从 V4.3.5 BP2 版本开始支持。|
