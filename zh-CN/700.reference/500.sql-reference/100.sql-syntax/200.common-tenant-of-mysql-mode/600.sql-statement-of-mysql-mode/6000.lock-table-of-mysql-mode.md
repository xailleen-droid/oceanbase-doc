...
> 说明
  对于 OceanBase 数据库 V4.3.5 版本，LOCK TABLES 语句功能从 V4.3.5 BP2 版本开始生效。
...
* 使用 `LOCK TABLES` 语句前，需要打开如下租户级配置项：
    ...
    > 注意
      开启对应租户的 enable_lock_priority 后，并不是所有节点都能立即感知到配置项。因此，需通过视图 GV$OB_PARAMETERS 查询所有节点上对应配置项的值，以保证租户下所有机器都生效。
