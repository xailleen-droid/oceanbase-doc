...
> 说明
  SDO_SRID 与 MySQL 模式的 SRID 含义一样，表示空间坐标系的 ID。更多关于 MySQL 模式空间参考系统的信息，请参见 空间参考系统 (SRS)。
...
> **说明**
>
> 上述示例中，每组坐标值都是一个二维平面上的点，表示几何图形在相应维度上的位置。在这个示例中，只涉及 X 和 Y 坐标，而 Z 坐标未给定，所以在坐标数组中没有 Z 坐标值。
