...
`APPEND` Hint 指定 `INSERT INTO SELECT` 开启旁路导入功能。更多信息，参见[使用 `INSERT INTO SELECT` 语句旁路导入数据](../../../../../../../../../620.obap/300.obap-import-data/20.bypass-import/100.overview-of-bypass-import.md)。
