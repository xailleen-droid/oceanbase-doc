...
| PUSH_SUBQ                      | 用于指示优化器尽早执行未改写成连接的子查询。> 说明对于 OceanBase 数据库 V4.3.5 版本，从 V4.3.5 BP2 版本开始支持 PUSH_SUBQ Hint。|
| NO_PUSH_SUBQ                   | 是 `PUSH_SUBQ` 的反向操作，用于优化器将未改写成连接的子查询放在最后执行。> 说明对于 OceanBase 数据库 V4.3.5 版本，从 V4.3.5 BP2 版本开始支持 NO_PUSH_SUBQ Hint。|
...
> 说明
  对于 OceanBase 数据库 V4.3.5 版本，从 V4.3.5 BP2 版本开始支持 PUSH_SUBQ Hint。
...
> 说明
  对于 OceanBase 数据库 V4.3.5 版本，从 V4.3.5 BP2 版本开始支持 NO_PUSH_SUBQ Hint。
