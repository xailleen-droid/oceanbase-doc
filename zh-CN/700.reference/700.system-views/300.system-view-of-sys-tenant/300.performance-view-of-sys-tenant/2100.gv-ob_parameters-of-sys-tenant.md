...
| DATA_TYPE  | varchar(128)   | YES        | 配置项值类型 > **说明**
>
...
| DEFAULT_VALUE | varchar(65536) | NO   | 配置项的默认值> 说明对于 V4.3.x 版本，该字段从 V4.3.1 版本开始引入。对于 V4.2.x 版本，该字段从 V4.2.2 版本开始引入。      |
| ISDEFAULT     | varchar(3)     | NO   | 当前值是否为默认值：<ul><li>NO：表示当前值不是默认值</li><li>YES：表示当前值为默认值</li></ul>> 说明对于 V4.3.x 版本，该字段从 V4.3.1 版本开始引入。对于 V4.2.x 版本，该字段从 V4.2.2 版本开始引入。     |
