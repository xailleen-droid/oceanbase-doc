...
> 说明
  在 V4.3.x 版本中，该视图从 V4.3.1 版本开始引入。在 V4.2.x 版本中，该视图从 V4.2.2 版本开始引入。

## 功能描述

视图 `GV$OB_PL_CACHE_OBJECT` 展示所有租户下的所有 Server 中 PL 相关的缓存对象的基础信息。
...
查询所有租户下的所有 Server 中 PL 相关的缓存对象的基础信息。
