...
| DATA_DISK_ALLOCATED     | bigint(20)   | NO         | <ul><li>SN 模式下，表示 OBServer 节点已分配的数据盘大小，单位为字节</li> <li> SS 模式下，该值等于`DATA_DISK_CAPACITY` 的值，表示整个空间可用。</li></ul><main id="notice" type='explain'><h4>说明</h4><p>该字段从 V4.2.0 版本开始引入。</p></main>    |
