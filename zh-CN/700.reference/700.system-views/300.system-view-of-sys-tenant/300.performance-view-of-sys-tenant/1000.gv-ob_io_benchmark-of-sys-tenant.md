...
查看所有节点上 I/O 模块所使用的磁盘校准数据，展示前 10 条记录。
...
* 查看当前 OBServer 节点上 I/O 模块使用的磁盘校准数据：[V$OB_IO_BENCHMARK](31200.v-ob_io_benchmark-of-sys-tenant.md)
