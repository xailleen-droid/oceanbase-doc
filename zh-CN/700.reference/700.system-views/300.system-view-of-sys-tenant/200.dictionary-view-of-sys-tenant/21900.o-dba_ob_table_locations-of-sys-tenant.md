...
| DUPLICATE_SCOPE | varchar(7) | NO | 表明这个表是否为复制表，取值为：<ul><li>`CLUSTER`：复制表  </li><li>`NONE`：普通表 </li></ul> > **说明**
>
> 该字段从 V4.2.0 版本开始引入。 |
...
>
> 该字段从 V4.3.4 版本开始引入。|
| OBJECT_ID | bigint(20) | NO | 分区对应的对象 ID> **说明**
>
> 该字段从 V4.2.0 版本开始引入。 |
| TABLEGROUP_NAME | varchar(128) | NO | 表对应 Table Group 的名称> **说明**
>
> 该字段从 V4.2.0 版本开始引入。 |
| TABLEGROUP_ID | bigint(20) | NO | 表对应 Table Group 的 ID> **说明**
>
> 该字段从 V4.2.0 版本开始引入。 |
| SHARDING | varchar(10) | NO | 表对应 Table Group 的 Sharding 属性（均衡模式）> **说明**
>
> 该字段从 V4.2.0 版本开始引入。 |
