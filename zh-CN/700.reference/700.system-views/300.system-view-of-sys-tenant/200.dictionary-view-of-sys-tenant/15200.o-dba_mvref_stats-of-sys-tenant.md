...
| REFRESH_OPTIMIZATIONS | text | NO | 刷新优化。例如，空刷新或物化视图刷新期间应用的主键/外键。> **说明**
>
> 该字段仅兼容，且值默认为 NULL。 |
| ADDITIONAL_EXECUTIONS | text | NO | 额外的执行。例如，索引重建或物化视图刷新期间涉及的日志操作。> **说明**
>
> 该字段仅兼容，且值默认为 NULL。 |
| START_TIME | datetime | NO | 刷新开始时间 |
| END_TIME | datetime | NO | 刷新结束时间 |
| ELAPSED_TIME | bigint(20) | NO | 刷新运行的时间长度，单位为秒 |
| LOG_SETUP_TIME | bigint(1) | NO | 物化视图的日志设置时间，单位为秒> **说明**
>
> 该字段仅兼容，且值默认为 0。 |
