...
| DEFAULT_VALUE | varchar(65536) | YES | 系统变量默认值> 说明对于 V4.3.x 版本，该字段从 V4.3.1 版本开始引入。对于 V4.2.x 版本，该字段从 V4.2.2 版本开始引入。|
| ISDEFAULT   | varchar(3)       | NO  |  是否是默认值> 说明对于 V4.3.x 版本，该字段从 V4.3.1 版本开始引入。对于 V4.2.x 版本，该字段从 V4.2.2 版本开始引入。 |
