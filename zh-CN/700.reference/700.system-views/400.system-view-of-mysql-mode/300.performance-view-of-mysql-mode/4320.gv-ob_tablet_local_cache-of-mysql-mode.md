...
> **说明**
>
> 对于 V4.3.5 版本，该视图从 V4.3.5 BP2 版本开始引入。
...
SS 模式下，用户租户查看本租户在所有 OBServer 节点上的整体缓存情况。

```shell
obclient> SELECT SVR_IP, SVR_POR, TENANT_ID, TABLET_ID, STORAGE_CACHE_POLICY, INFO FROM oceanbase.GV$OB_TABLET_LOCAL_CACHE;
```
