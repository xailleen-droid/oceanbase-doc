...
| ID3 | varchar(512) | NO | 锁标识符 3：<ul><li>TM：TABLE_ID / TABLET_ID</li><li>TX：NULL</li><li>TR：TABLET_ID + 行 rowkey</li></ul> > 说明在 V4.3.x 版本中，该字段从 V4.3.2 版本开始引入。在 V4.2.x 版本中，该字段从 V4.2.5 版本开始引入。|
