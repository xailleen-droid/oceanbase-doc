...
> 说明
对于 V4.3.x 版本，该视图从 V4.3.5 版本开始引入。 对于 V4.2.x 版本，该视图从 V4.2.2 版本开始引入。
...
| DELTA_READ_IO_REQUESTS      | NUMBER          | NO | 两次采样之间读的次数。> 说明对于 V4.3.x 版本，该字段从 V4.3.5 BP2 版本开始引入。 对于 V4.2.x 版本，该字段从 V4.2.5 BP3 版本开始引入。     |
| DELTA_READ_IO_BYTES         | NUMBER          | NO | 两次采样之间读的文件累计大小。> 说明对于 V4.3.x 版本，该字段从 V4.3.5  BP2 版本开始引入。 对于 V4.2.x 版本，该字段从 V4.2.5 BP3 版本开始引入。     |
| DELTA_WRITE_IO_REQUESTS     | NUMBER          | NO | 两次采样之间写的次数。> 说明对于 V4.3.x 版本，该字段从 V4.3.5 BP2 版本开始引入。 对于 V4.2.x 版本，该字段从 V4.2.5 BP3 版本开始引入。     |
| DELTA_WRITE_IO_BYTES        | NUMBER          | NO | 两次采样之间写的文件累计大小。> 说明对于 V4.3.x 版本，该字段从 V4.3.5 BP2 版本开始引入。 对于 V4.2.x 版本，该字段从 V4.2.5 BP3 版本开始引入。     |
