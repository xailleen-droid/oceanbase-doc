...
>
> 该字段从 V4.2.1 版本开始引入。 |
| LB_VID           | NUMBER(38)     | NO         | 如果是公有云环境上通过负载均衡直接连接数据库，则本列显示的是负载均衡服务的 VPC ID。否则显示为 NULL> **说明**
>
> 该字段从 V4.2.1 版本开始引入。 |
| LB_VIP           | VARCHAR2(46)   | NO         | 如果是公有云环境上通过负载均衡直接连接数据库，则本列显示的是客户端连接负载均衡服务的 IP。否则显示为 NULL> **说明**
>
> 该字段从 V4.2.1 版本开始引入。 |
| LB_VPORT         | NUMBER(38)     | NO         | 如果是公有云环境上通过负载均衡直接连接数据库，则本列显示的是客户端连接负载均衡服务的端口。否则显示为 NULL> **说明**
>
> 该字段从 V4.2.1 版本开始引入。 |
...
| MEMORY_USAGE     | NUMBER(38)     | NO         | 单条 SQL 语句当前占用的内存大小，单位为字节   > **说明**
>
