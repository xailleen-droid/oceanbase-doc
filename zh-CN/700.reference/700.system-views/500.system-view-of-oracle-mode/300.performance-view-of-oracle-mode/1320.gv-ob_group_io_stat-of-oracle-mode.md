...
| NORM_IOPS                    | NUMBER(38)   | NO             | 当前的 IOPS（转换为 16 KB 读对应的值进行展示）<main id="notice" type='explain'><h4>说明</h4><p>对于 V4.3.5 版本，该字段从 V4.3.5 BP1 版本开始引入。</p></main>  |
...
* 查看本租户当前节点上各资源组的实时状态：[V$OB_GROUP_IO_STAT](31920.v-ob_group_io_stat-of-oracle-mode.md)
