...
| DATA_TYPE  | VARCHAR2(128)   | YES        | 配置项值类型    > **说明**
>
> 从 V4.3.0 版本开始，该字段的值由 `NULL` 变更为展示配置项的具体类型信息。   |
...
| DEFAULT_VALUE | VARCHAR2(65536) | NO   | 配置项的默认值> 说明对于 V4.3.x 版本，该字段从 V4.3.1 版本开始引入。对于 V4.2.x 版本，该字段从 V4.2.2 版本开始引入。       |
| ISDEFAULT     | VARCHAR2(3)     | NO   | 当前值是否为默认值：<ul><li>NO：表示当前值不是默认值</li><li>YES：表示当前值为默认值</li></ul>> 说明对于 V4.3.x 版本，该字段从 V4.3.1 版本开始引入。对于 V4.2.x 版本，该字段从 V4.2.2 版本开始引入。 |
