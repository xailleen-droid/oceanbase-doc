...
| LAST_PURG_ESTATUS | NUMBER | NO | 表示上次清除物化视图日志的状态<ul><li>错误代码  </li><li>0 ：表示成功 </li></ul><main id="notice" type='explain'> <h4>说明</h4><p>目前该字段值恒为 0。</p></main> |
...
| PURGE_DOP          | NUMBER(38)    | NO   | 清理物化视图日志的并行度。<main id="notice" type='explain'><h4>说明</h4><p>对于 OceanBase 数据库 V4.3.5 版本，该字段从 V4.3.5 BP2 版本开始引入。</p></main>|
| LAST_PURGE_TIME    | NUMBER(38)    | YES  | 上一次清理物化视图日志任务的耗时，单位秒。<main id="notice" type='explain'><h4>说明</h4><p>对于 OceanBase 数据库 V4.3.5 版本，该字段从 V4.3.5 BP2 版本开始引入。</p></main>|
