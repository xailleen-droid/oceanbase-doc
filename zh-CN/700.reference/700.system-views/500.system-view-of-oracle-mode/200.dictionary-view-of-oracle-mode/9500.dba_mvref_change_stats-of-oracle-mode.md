...
| NUM_ROWS_DL_INS | NUMBER | NO | direct load insert 行数> **说明**
>
> 该字段仅兼容，且值默认为 0。 |
| PMOPS_OCCURRED | CHAR(1) | NO | 指示是否发生分区维护操作 (PMOP)<ul><li>Y  </li><li>N </li><li>NULL </li></ul>> **说明**
>
> 该字段仅兼容，且值默认为 N。 |
| PMOP_DETAILS | VARCHAR2(4000) | NO | PMOP 的详细信息采用以下格式<ul><li>TRUNCATE (low_bound, high_bound)  </li><li>EXECHANGE (low_bound, high_bound) </li></ul>> **说明**
>
> 该字段仅兼容，且值默认为 NULL。 |
