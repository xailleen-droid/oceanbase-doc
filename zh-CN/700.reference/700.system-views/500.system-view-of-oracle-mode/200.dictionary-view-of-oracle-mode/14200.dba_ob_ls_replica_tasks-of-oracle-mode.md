...
| DATA_SOURCE_SVR_IP     | VARCHAR2(46)   | YES                | 数据源 IP  > 说明在 V4.3.x 版本中，该字段从 V4.3.3 版本开始引入。在 V4.2.x 版本中，该字段从 V4.2.3 版本开始引入。    |
| DATA_SOURCE_SVR_PORT   | NUMBER(38)     | YES                | 数据源 PORT  > 说明在 V4.3.x 版本中，该字段从 V4.3.3 版本开始引入。在 V4.2.x 版本中，该字段从 V4.2.3 版本开始引入。   |
| IS_MANUAL              | CHAR(6)        | NO                 | 容灾任务来源，可取值：<ul><li>`TRUE`：表示手动运维命令触发的容灾任务</li><li>`FALSE`：默认值，表示 RS 层容灾自动生成的容灾任务</li></ul>  > 说明在 V4.3.x 版本中，该字段从 V4.3.3 版本开始引入。在 V4.2.x 版本中，该字段从 V4.2.3 版本开始引入。    |
