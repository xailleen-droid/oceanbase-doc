...
查询整个数据库中关于 `GRANT`、`REVOKE`、`AUDIT`、`NOAUDIT` 和 `ALTER SYSTEM` 语句的审计跟踪记录。
...
查询当前用户有关 `GRANT`、`REVOKE`、`AUDIT` 等语句的审计跟踪条目：[USER_AUDIT_STATEMENT](25300.user_audit_statement-of-oracle-mode.md)
