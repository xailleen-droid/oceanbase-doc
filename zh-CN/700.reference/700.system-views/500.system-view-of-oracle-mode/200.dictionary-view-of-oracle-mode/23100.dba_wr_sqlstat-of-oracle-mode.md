...
| ROUTE_MISS_TOTAL              | NUMBER(38)                              | NO   |   从 OBServer 启动开始，没有命中请求分区的总次数> 说明对于 V4.3.x 版本，该字段从 V4.3.5 版本开始引入。 对于 V4.2.x 版本，该字段从 V4.2.2 版本开始引入。   |
| ROUTE_MISS_DELTA              | NUMBER(38)                              | NO   |   从上次 WR 快照采集开始，没有命中请求分区的次数> 说明对于 V4.3.x 版本，该字段从 V4.3.5 版本开始引入。 对于 V4.2.x 版本，该字段从 V4.2.2 版本开始引入。   |
| FIRST_LOAD_TIME               | TIMESTAMP(6) WITH LOCAL TIME ZONE       | YES  |   计划生成时间> 说明对于 V4.3.x 版本，该字段从 V4.3.5 版本开始引入。 对于 V4.2.x 版本，该字段从 V4.2.5 版本开始引入。   |
| PLAN_CACHE_HIT_TOTAL          | NUMBER(38)                              | NO   |   从 OBServer 启动开始，命中 Plan Cache 的总次数> 说明对于 V4.3.x 版本，该字段从 V4.3.5 版本开始引入。 对于 V4.2.x 版本，该字段从 V4.2.5 版本开始引入。   |
| PLAN_CACHE_HIT_DELTA          | NUMBER(38)                              | NO   |   从上次 WR 快照采集开始，命中 Plan Cache 的次数> 说明对于 V4.3.x 版本，该字段从 V4.3.5 版本开始引入。 对于 V4.2.x 版本，该字段从 V4.2.5 版本开始引入。  |
