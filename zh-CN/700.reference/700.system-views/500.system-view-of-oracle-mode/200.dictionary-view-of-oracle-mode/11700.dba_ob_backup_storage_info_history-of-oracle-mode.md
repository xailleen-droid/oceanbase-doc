...
| MAX_IOPS             | NUMBER(38)   | NO | 备份使用的备份介质允许的最大 IOPS > **说明**
>
> 该字段从 V4.3.5 版本开始引入。    |
| MAX_BANDWIDTH        | NUMBER(38)   | NO | 备份使用的备份介质允许的最大带宽，单位为字节 > **说明**
>
> 该字段从 V4.3.5 版本开始引入。      |
| MAX_BANDWIDTH_DISPLAY| VARCHAR2(44) | NO | 最大带宽转换格式后的展示，转换后的格式类似 10GB/s、10MB/s > **说明**
>
> 该字段从 V4.3.5 版本开始引入。      |
