...
| DATA_PROGRESS                 | NUMBER         | NO              | 数据备份的备份进度。计算方法为 `完成的宏块个数 / 总宏块个数`，结果保留两位小数 。例如，87.65 表示当前进度为 87.65%。  > **说明**
>
> 该字段从 V4.3.1 版本开始引入。    |
| LOG_FILE_COUNT                | NUMBER(38)     | NO              | 归档 clog 文件的总数  > **说明**
>
> 该字段从 V4.3.1 版本开始引入。     |
| FINISH_LOG_FILE_COUNT         | NUMBER(38)     | NO              | 完成备份的归档 clog 文件的个数  > **说明**
>
> 该字段从 V4.3.1 版本开始引入。     |
| LOG_PROGRESS                  | NUMBER         | NO              | 归档 clog 文件的备份进度。计算方法为 `已完成备份的归档 clog 文件的个数 / 归档 clog 文件的总数`，结果保留两位小数。例如，87.65 表示当前进度为 87.65%。    > **说明**
>
> 该字段从 V4.3.1 版本开始引入。    |
