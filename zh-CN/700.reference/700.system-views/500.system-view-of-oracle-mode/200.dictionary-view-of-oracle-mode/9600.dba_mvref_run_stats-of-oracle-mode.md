...
| --- | --- | --- | --- |
| RUN_OWNER | VARCHAR2(128) | NO | 刷新操作的所有者（发起该操作的用户） |
...
| LOG_SETUP_TIME | NUMBER | NO | 物化视图的日志设置时间，单位为秒> **说明**
>
> 该字段仅兼容，且值默认为 0。 |
| LOG_PURGE_TIME | NUMBER | NO | 物化视图的日志清除时间，单位为秒 |
| COMPLETE_STATS_AVAILABLE | CHAR(1) | NO | 指示所有完整刷新统计信息是否可用于此运行<ul><li> Y </li><li>N </li></ul>> **说明**
>
> 该字段仅兼容，且值默认为 Y。 |
