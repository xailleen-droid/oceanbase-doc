...
* 物化视图日志支持 LOB 类型的列，但是仅支持 LOB 数据内联存储。有关 LOB 类型的介绍信息，参见 [LOB 类型](../../../../500.sql-reference/100.sql-syntax/300.common-tenant-of-oracle-mode/300.basic-elements-of-oracle-mode/100.built-in-data-types-of-oracle-mode/600.large-object-data-type-of-oracle-mode/400.lob-type-of-oracle-mode.md)。

    > **注意**
>
> 对于 OceanBase 数据库 V4.3.5 版本，物化视图日志从 V4.3.5 BP1 版本开始支持 LOB 类型的列。
...
|   **列名**  | **类型** | **说明** |
|-------------|----------|----------|
| sequence$$  | in64_t   | 自增列，为物化视图日志（mlog）的主键列。> 说明mlog 的主键由基表的主键、所有分区键（如果存在）以及自增列 sequence$$ 组成，形成复合主键。|
...
* 您可以通过 [DBMS_MVIEW.PURGE_LOG(table_name)](../../../../600.pl-reference/300.pl-oracle/1400.pl-system-package-oracle/9950.dbms-mview-oracle/200.purge-log-oracle.md) 来对某个基表的物化视图日志执行 `PURGE` 操作。
...
> **说明**
>
> 对于 OceanBase 数据库 V4.3.5 版本，从 V4.3.5 BP1 版本开始支持修改物化视图日志。
...
有关修改物化视图日志语法的详细参数说明信息，请参见 [ALTER MATERIALIZED VIEW LOG](../../../../500.sql-reference/100.sql-syntax/300.common-tenant-of-oracle-mode/900.sql-statement-of-oracle-mode/100.ddl-of-oracle-mode/251.alter-materialized-view-log-of-oracle-mode-in-sql.md)。
...
4. 查看表 `test_tbl1` 物化视图日志日志信息。
    ...
    > 注意
      Oracle 模式中视图 sys.DBA_MVIEW_LOGS 中字段 MASTER 匹配表名时，表名需使用大写字母。
